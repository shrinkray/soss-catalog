...
### Soss eCommerce Theme 8.5.1: September 4, 2019
* Complete Card #321, adding Single Product sub-nav above variation section
* Incl: revision to SCSS, content-page-documents, main.js
* Fix bug in mega-menu, item 1 where flap corner is missing on production server
* Refactor Single Product sub-nav CSS
* Refactor CSS in general, adding variable for hover color
* Refactor webpack.config -- hardcoding necessary to temporarily set CSS and JS to non-hash version.

### Soss eCommerce Theme 8.5.1: May 16, 2019
* Improve calculator transitioning for help messaging 
* Refactor video templates, for customer portal and single video
* Add help message to Focal Row ACF backend screen 

### Soss eCommerce Theme 8.5.1: May 15, 2019
* Refactor Calculator adding better hotspot buttons and messaging
* Swap out help message when animation plays
* Fix bug on Focal row 3 to 4 buttons

### Soss eCommerce Theme 8.5.1: May 14, 2019
* Improve Calculator form with accessibility setup
* Add Hinge Calculator GSAP Animation
* Refactor Theme 
* Update Bootstrap to 4.3.1
* Running on Webpack 4, version 1.0.0  ( Feb 2019 )
* Upgrade to Yarn 1.5.2
