  ...
  if(solution_matches.length === 0) {
    ...
    else
    {
      for(let i=0; i < solution_matches.length; i++) {
        ...
        let explore_btn = `<span class="big">Explore the ${solution_value}</span>
...
<a href="${family_url}" class="family cta-brand cta-disabled btn" title="See finishes, forms and variations!" >
       ${explore_btn}
</a>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="table-on-left">
        ...
        <button id="try-now" class="btn btn-refresh hide brand-cta-gray fade-in mb-4" type="button" onclick="refresh_page()">
    ...
    <div class="col-md-6">
      ...
      <div id="gallery-message" class="gallery-message w-100 h-100 text-center d-flex justify-content-center align-items-center mb-4">
