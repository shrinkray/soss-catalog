...
$right_pic = wp_get_attachment_image($right_image, 'router_image', false, $attr = array('class' => 'align-self-center right-router' ));
$left_pic = wp_get_attachment_image($left_image, 'router_image', false, $attr = array('class' => 'align-self-center left-router')); ?>
